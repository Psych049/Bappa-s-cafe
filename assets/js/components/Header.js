...
export function Header(state) {
  return `
    <div class="sticky top-0 z-50 glass-header border-b border-slate-200/60 dark:border-slate-800/80 transition-all duration-300 w-full pt-3 sm:pt-4 pb-2 sm:pb-3 px-4 sm:px-6 lg:px-8">
